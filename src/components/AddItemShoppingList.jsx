        ...
        return (
            <div className="addItemWrapper">
                <div className="addItemContainer">
                    ...
                    <button className="addItemButton addItemButtonActive" onClick={()=> this.props.updateItemComponentsByCategory(this.props.itemsToCategories.get(this.state.itemName), {id: this.props.nextItemId, name: this.state.itemName, quantity: this.state.itemQuantity, unit: this.state.itemUnit, checked: false})}>Add Item(s)</button>
                </div>
            </div>
        );
    }
