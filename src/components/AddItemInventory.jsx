    ...
    <div className='PageWrapper'>
      <div className={`addItemInventoryContainer ${itemsAddedOpen ? "blurWall" : ""}`}>
        ...
        <div className='ShoppingListandButton'>
          ...
          <Link to="/inventory/addOfficeRefrigeratorItem" className="linkAdd" color='#007AFF;'> 
      ...
      {itemsAddedOpen ? <ItemsAddedNotification addedToName="Inventory" onClose={() => setItemsAddedOpen(false)} pathToGoTo="/inventory/OfficeRefrigerator" /> : null}
