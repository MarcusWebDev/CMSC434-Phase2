    ...
    <div className='PageWrapper'>
      <div className={`addItemInventoryContainer ${itemsAddedOpen ? "blurWall" : ""}`}>
        <div className='HeaderContainer'>
          <Link to="/inventory/LakeHouseRefrigerator" className="linkBack2" > <img className="linkBackimage" src={BackArrow} />  Back</Link>
        ...
        <div className='ShoppingListandButton'>
          ...
          <Link to="/inventory/addLakeHouseRefrigeratorItem" className="linkAdd" color='#007AFF;'> 
      ...
      {itemsAddedOpen ? <ItemsAddedNotification addedToName="Inventory" onClose={() => setItemsAddedOpen(false)} pathToGoTo="/inventory/LakeHouseRefrigerator" /> : null}
